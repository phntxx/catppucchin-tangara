...
local colors = {
	background = "#eff1f5",
	secondary = "#dce0e8", -- using crust
	surface = "#ccd0da", -- using surface 0
	overlay = "#9ca0b0", -- using overlay 0
	body = "#4c4f69",
	main_headline = "#4c4f69",
	sub_headline = "#6c6f85", -- using subtext 0
	subtle = "#8c8fa1",
	links = "#1e66f5",
	success = "#40a02b",
	warning = "#df8e1d",
